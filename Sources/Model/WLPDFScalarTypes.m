...
#import "WLPDFScalarTypes.h"
#import "WLPDFObjectInternal.h"

@implementation WLPDFNull
...
@implementation WLPDFBoolean

- (NSString*)typeName {
	return NSLocalizedString(@"Boolean",
      @"Name of type for boolean PDF objects");
}

- (NSString*)stringRepresentation {
	return self.booleanValue ?
      NSLocalizedString(@"True",
          @"String representation for a true value of boolean PDF object") :
      NSLocalizedString(@"False",
          @"String representation for a false value of boolean PDF object");
}
...
@implementation WLPDFInteger

- (NSString*)typeName {
	return NSLocalizedString(@"Integer",
      @"Name of type for integer PDF objects");
}

- (NSString*)stringRepresentation {
  NSString* format = NSLocalizedString(@"%ld",
      @"Format for string representation of integer PDF objects");
...
- (NSString*)stringRepresentation {
  NSString* format = NSLocalizedString(@"%f",
      @"Format for string representation of real PDF objects");
